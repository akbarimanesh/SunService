...
namespace SunService.Infra.Data.Db.SqlServer.Dapper
{
    public static class QuerysSundb
    {
        ...
        public static string GetAllSubCategories = "SELECT sc.Id, sc.Title, sc.CategoryId,  c.Title AS CategoryName, c.ImagePath  FROM SubCategories AS sc INNER JOIN Categories AS c ON c.Id = sc.CategoryId;";
