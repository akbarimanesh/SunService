    ...
    public class HomeServiceConfigurations : IEntityTypeConfiguration<HomeService>
    {
        public void Configure(EntityTypeBuilder<HomeService> builder)
        {
            ...
            builder.HasData(new List<HomeService>()
            {
                ...
                new HomeService() { Id = 11, Title = "زیبایی بانوان",Description="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است",BasePrice=5000000,NumberVisits=149,ImagePath = "\\Images\\Homeservice\\Women-beauty-homeservice_image.jpg",SubCategoryId=11},
